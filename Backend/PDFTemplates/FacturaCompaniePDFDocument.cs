...
{
    public class FacturaCompaniePDFDocument : IDocument
    {
        ...
        public FacturaCompaniePDFDocument(int facturiId, string numeCompanie, IEnumerable<(Piese Piesa, TotalPiesaFactura Total)> liniiFactura)
        {
        ...
        public void Compose(IDocumentContainer container)
        {
            container.Page(page =>
            {
                ...
                page.Header().Row(row =>
                {
                    ...
                    {
                        col.Item().Text($"Factură Companie #{_facturiId}").Bold().FontSize(18).FontColor(Colors.Blue.Medium);
